...
public class TotalViewPlayerFireFront : MonoBehaviour
{
            ...
            switch (changeWeapon)
            {
                ...
                case 2:
                    ...
                    if (powerUpCount == 2)
                    {
                        ...
                        myLaserBeamVersion2Left[0].transform.eulerAngles = new Vector3(0.0f, 190.0f, 0.0f);
                        ...
                        myLaserBeamVersion2Left[1].transform.eulerAngles = new Vector3(0.0f, 190.0f, 0.0f);
                        ...
                        myLaserBeamVersion2Right[0].transform.eulerAngles = new Vector3(0.0f, -190.0f, 0.0f);
                        ...
                        myLaserBeamVersion2Right[1].transform.eulerAngles = new Vector3(0.0f, -190.0f, 0.0f);
                    }
                    ...
                    if (powerUpCount >= 3)
                    {
                        ...
                        myLaserBeamVersion3Left[0].transform.eulerAngles = new Vector3(0.0f, -190.0f, 0.0f);
                        ...
                        myLaserBeamVersion3Left[1].transform.eulerAngles = new Vector3(0.0f, -190.0f, 0.0f);
                        ...
                        myLaserBeamVersion3Right[0].transform.eulerAngles = new Vector3(0.0f, 190.0f, 0.0f);
                        ...
                        myLaserBeamVersion3Right[1].transform.eulerAngles = new Vector3(0.0f, 190.0f, 0.0f);
                    }
