...
public class TotalViewBossSideLaserFire : MonoBehaviour
{
    ...
    void Fire()
    {
        ...
        switch(randomValue)
        {
            case 1: // left
                ...
                LaserShot[0].transform.eulerAngles = new Vector3(shotSpawn.transform.rotation.x - 255.0f, shotSpawn.transform.rotation.y, shotSpawn.transform.rotation.z);
                break;
            ...
            case 3: // right
                ...
                LaserShot[2].transform.eulerAngles = new Vector3(shotSpawn.transform.rotation.x + 72.0f, shotSpawn.transform.rotation.y, shotSpawn.transform.rotation.z);
